...
For **numbers** — look up the problem title from the study plan in AGENTS.md or AGENTS.md. The study plan lists problem numbers by phase/day. Map the number to its title before calling the script. Common mappings from the study plan:
